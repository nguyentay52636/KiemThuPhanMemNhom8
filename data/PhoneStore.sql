-- Cơ sở dữ liệu: Quản lý điện thoại
--
...
--
-- Đang đổ dữ liệu cho bảng chi tiết hoá đơn
--
...
--
-- Đang đổ dữ liệu cho bảng chi tiết phiếu nhập
--
...
--
-- Đang đổ dữ liệu cho bảng hóa đơn
--
...
--
-- Cấu trúc bảng cho bảng khách hàng
--
...
--
-- Đang đổ dữ liệu cho bảng khách hàng
--
...
--
-- Cấu trúc bảng cho bảng khuyến mãi
--
...
--
-- Cấu trúc bảng cho bảng loại sản phẩm
--
...
--
-- Đang đổ dữ liệu cho bảng loại sản phẩm
--
...
--
-- Đang đổ dữ liệu cho bảng nhà cung cấp
--
...
INSERT INTO `employee` (`MaNV`, `TenNV`, `NgaySinh`, `DiaChi`, `SDT`, `TrangThai`) VALUES
                                                                                       ...
                                                                                       ('NV12', 'Nguyễn Thiên Thuận', '1989-06-15', 'Kiên Giang', '0981578293', 0),
                                                                                       ...
                                                                                       ('NV20', 'Nguyễn Hồ Phương Tây', '1997-02-14', 'Hải Phòng', '0702536184', 0),
...
--
-- Cấu trúc bảng cho bảng phân quyền
--
...
--
-- Đang đổ dữ liệu cho bảng phân quyền
--
...
--
-- Cấu trúc bảng cho bảng phiếu nhập
--
...
--
-- Đang đổ dữ liệu cho bảng phiếu nhập
--
...
INSERT INTO `account` (`TenTaiKhoan`, `MatKhau`, `MaNV`, `MaQuyen`) VALUES
                                                                        ('admin', 'admin@123', 'NV12', 'Q4'),
                                                                        ('BaDuocSeller', 'baduoc@123', 'NV3', 'Q2'),
                                                                        ('NhanVien', 'feafe@123', 'NV20', 'Q2'),
                                                                        ('Quan Ly', 'quanly@123', 'NV9', 'Q1'),
                                                                        ('ThanhTuNH', 'thanhtu@434', 'NV5', 'Q5'),
                                                                        ('TriDungSeller', 'tridung@fe3', 'NV1', 'Q2'),
                                                                        ('VanHoangAdmin', 'vanhoang@feaf2', 'NV4', 'Q3'),
                                                                        ('VanTaiNH', 'vantai@1212', 'NV12', 'Q5'),
                                                                        ('YenHanPhuBH', 'yenhan@123', 'NV23', 'Q3');
...
--
-- Chỉ mục cho bảng chi tiết hóa đơn
--
...
--
-- Chỉ mục cho bảng chi tiết phiếu nhập
--
...
--
ALTER TABLE `account`
    ADD CONSTRAINT `account_ibfk_2` FOREIGN KEY (`MaNV`) REFERENCES `employee` (`MaNV`) ON UPDATE CASCADE,
    ADD CONSTRAINT `account_ibfk_3` FOREIGN KEY (`MaQuyen`) REFERENCES `permission` (`MaQuyen`) ON UPDATE CASCADE;
COMMIT;
