...
CREATE DATABASE IF NOT EXISTS Quanlysieuthidienthoai;
USE Quanlysieuthidienthoai;

--
-- Cấu trúc bảng cho bảng chi tiết hoá đơn
--
...
INSERT INTO `product_category` (`MaLSP`, `TenLSP`, `Mota`) VALUES
...
INSERT INTO `supplier` (`MaNCC`, `TenNCC`, `DiaChi`, `SDT`, `Fax`) VALUES
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `product_ibfk_1` FOREIGN KEY (`MaLSP`) REFERENCES `product_category` (`MaLSP`) ON UPDATE CASCADE;
