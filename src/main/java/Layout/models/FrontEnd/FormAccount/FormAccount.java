/*
 * Created by JFormDesigner on Tue Apr 23 08:39:45 ICT 2024
 */
...
public class FormAccount extends JPanel {
    ...
    public FormAccount() {
        initComponents();
        ArrayList<Account> allAccounts = qltk.getAllAccounts();
