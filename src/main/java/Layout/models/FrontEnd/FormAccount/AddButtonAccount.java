...
public class AddButtonAccount extends JFrame {
    ...
    String type;
    AccountBUS qltkBUS = new AccountBUS();
    Account tkSua;
    ...
    public void setAccountAddedListener(FormAccount.AccountAddedListener listener) {
    ...
    private void btnSuaMouseClicked() {
        if (checkEmpty()) {
            ...
            Account fixAccount = new Account(username, pass, manv, maquyen);
    ...
    public static void main(String[] args) throws UnsupportedLookAndFeelException, ClassNotFoundException,
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new AddButtonAccount("Thêm", "master");
            }
        });
    }
}
