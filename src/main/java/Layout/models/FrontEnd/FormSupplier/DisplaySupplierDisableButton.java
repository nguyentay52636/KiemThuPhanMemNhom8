...
public class DisplaySupplierDisableButton extends JFrame {
     ...
     * Create the frame.
     */
    public DisplaySupplierDisableButton() {
        ...
        buttonview.addActionListener( new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (Select != -1) { // -1 là chỉ mục mặc định nếu không có hàng nào được chọn
                    ...
                    JOptionPane.showMessageDialog(DisplaySupplierDisableButton.this, "Vui lòng chọn một nhân viên để xem", "Thông báo", JOptionPane.WARNING_MESSAGE);
                }
        ...
        button2.addActionListener( new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(Select!=-1) {
                    ...
                    JOptionPane.showMessageDialog(DisplaySupplierDisableButton.this, "Vui lòng chọn một NCC để chỉnh sửa", "Thông báo", JOptionPane.WARNING_MESSAGE);
                }
    ...
    public void Trangthai(String option) {
        ...
        panel2.setVisible(option.equals("Đang hoạt động"));
